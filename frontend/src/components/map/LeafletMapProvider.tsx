...
import type { MapPosition, MapProvider } from './MapProvider';
...
function getCenter(positions: MapPosition[]): MapPosition {
  return [
  ...
  >
    ...
    {polylines.map(polyline => (
      <Polyline
        ...
        pathOptions={{ color: polyline.color, weight: 3, opacity: 0.6, dashArray: '8 6' }}
      />
    ))}
